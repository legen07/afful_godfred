...
const statusLabel: Record<AutomationProject['status'], string | null> = {
  public: null,
      ...
      <div className="section-inner">
        <Reveal>
          ...
          <h2 className="section-title">
            Things I <em>automate</em>.
          </h2>
          <p className="section-lede">
            Scrapers, bots, and pipelines — some personal, some for clients, some still under
            construction. Everything public lives on GitHub.
          </p>
        </Reveal>
